...
class KWMainWindow : public QWidget {
    Q_OBJECT
...
public:
     ...
     * Constructor.
     */
    KWMainWindow( const char *name = 0L );
    /**
...
protected:
   ...
   * accessible from subclasses (Jochen)
   */
  static QList<KWMainWindow>* memberList;
...
protected:
  // for window independent data like documents (Jochen)
...
#define RESTORE(type) { int n = 1;\
    while (KWMainWindow::canBeRestored(n)){\
      (new type)->restore(n);\
      n++;}}
